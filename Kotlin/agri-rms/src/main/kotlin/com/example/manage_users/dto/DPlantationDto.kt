...
class DPlantationDto {

    // ─────────────────────────────────────────────
//  D_PLANTATION DTOs
//  Accès : CRUD géré par SUPER_ADMIN
//          UPDATE délégué au D_GENERALE si besoin
//  Permission assignée : GESTION_SITE
// ─────────────────────────────────────────────

    /**
     * Création d'un Directeur de Plantation.
     */
    data class DPlantationCreateDto(
        ...
        val role: UserRole = UserRole.D_PLANTATION,
        val permission: Permission = Permission.GESTION_SITE,
        val status: UserStatus = UserStatus.PENDING_VERIFICATION
    )

    /**
     * Mise à jour d'un Directeur de Plantation.
     */
    data class DPlantationUpdateDto(
    ...
    /**
     * Réponse pour un Directeur de Plantation.
     */
    data class DPlantationResponseDto(
        val id: String,
        val email: String,
