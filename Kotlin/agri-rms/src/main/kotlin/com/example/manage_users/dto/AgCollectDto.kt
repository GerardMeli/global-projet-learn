...
//  Permission assignée : COLLECTE
// ─────────────────────────────────────────────

    /**
     * Création d'un Agent de Collecte.
     */
    data class AgCollecteCreateDto(
        ...
        val role: UserRole = UserRole.AG_COLLECTE,
        val permission: Permission = Permission.COLLECTE,
        val status: UserStatus = UserStatus.PENDING_VERIFICATION
    )

    /**
     * Mise à jour d'un Agent de Collecte.
     */
    data class AgCollecteUpdateDto(
    ...
    /**
     * Réponse pour un Agent de Collecte.
     * Vue minimale — pas d'exposition des champs sensibles.
     */
    data class AgCollecteResponseDto(
        val id: String,
        val email: String,
