...
//  Permission assignée : LOGISTIQUE
// ─────────────────────────────────────────────

    /**
     * Création d'un Agent de Terrain.
     */
    data class AgTerrainCreateDto(
        ...
        val role: UserRole = UserRole.AG_TERRAIN,
        val permission: Permission = Permission.OPERATIONEL,
        val status: UserStatus = UserStatus.PENDING_VERIFICATION
    )

    /**
     * Mise à jour d'un Agent de Terrain.
     */
    data class AgTerrainUpdateDto(
    ...
    /**
     * Réponse pour un Agent de Terrain.
     */
    data class AgTerrainResponseDto(
        val id: String,
        val email: String,
